...
join_hyperv (){
    run_wsmancmd_with_retry $1 $2 $3 'powershell -ExecutionPolicy RemoteSigned Remove-Item -Recurse -Force C:\OpenStack\neutron-ci ; git clone https://github.com/andreibacos/neutron-ci C:\OpenStack\neutron-ci ; cd C:\OpenStack\neutron-ci ; git checkout master >>\\'$FIXED_IP'\openstack\logs\create-environment-'$1'.log 2>&1'
