...
function archive_devstack_configs() {
    ...
    cp $DIR2/testLists/excluded-tests.txt "$CONFIG_DST_DEVSTACK/excluded-tests.txt"
    cp $DIR2/testLists/isolated-tests.txt "$CONFIG_DST_DEVSTACK/isolated-tests.txt"
