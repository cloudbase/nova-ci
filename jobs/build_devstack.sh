...
# run devstack
run_ssh_cmd_with_retry ubuntu@$DEVSTACK_IP $DEVSTACK_SSH_KEY "/home/ubuntu/bin/run_devstack.sh $hyperv01 $ZUUL_CHANGE" 5

# run post_stack
run_ssh_cmd_with_retry ubuntu@$DEVSTACK_IP $DEVSTACK_SSH_KEY "source /home/ubuntu/devstack/openrc admin admin && /home/ubuntu/bin/post_stack.sh" 5
